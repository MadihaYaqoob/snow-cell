...
// my imports -----
import VirtualServers from "layouts/services/virtual-servers";
import ApiAccess from "layouts/services/api-access";
import SshKeys from "layouts/services/ssh-keys";
...
const routes = [
    ...
    collapse: [
      {
        ...
        key: "virtual-servers",
        route: "/services/virtual-servers",
        component: <VirtualServers />,
      },
      {
        name: "API Access",
        key: "api-access",
        route: "/services/api-access",
        component: <ApiAccess />,
      },
      {
        name: "SSH Keys",
        key: "ssh-keys",
        route: "/services/ssh-keys",
        component: <SshKeys />,
      },
    ],
  },
    ...
    collapse: [
      {
        name: "Docker Images",
        key: "docker-images",
        route: "/images/docker-images",
        component: <Analytics />,
      },
      {
        name: "VM Images",
        key: "vm-images",
        route: "/images/vm-images",
        component: <Sales />,
      },
      {
  ...
  //       component: <ProtectedRoute component={ProfileOverview} />, // Protected Route
  //     },
  //     {
  //       name: "Settings",
